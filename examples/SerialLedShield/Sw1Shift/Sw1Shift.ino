...
const uint8_t led_play_list1[][SERIALCOMMAND_FIXEDLEN] =
{
  ...
  { 0x8C, 0x00, 0x23, 0x00, 0x07, 0x00, 0x00, 0x00 }, /* Color green 1-3*/
  { 0x92, 0x00, 0x01, 0x00, 0x32, 0x00, 0x32, 0x00 }, /* Shift right rotating 50ms 50*/
  { 0x8C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00 }, /* Color clear */
...
const uint8_t led_play_list2[][SERIALCOMMAND_FIXEDLEN] =
{
  ...
  { 0x90, 0x01, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00 }, /* System */
  { 0x8C, 0x00, 0x23, 0x00, 0x07, 0x00, 0x00, 0x00 }, /* Color green 1-3*/
  { 0x92, 0x01, 0x01, 0x00, 0x32, 0x00, 0x32, 0x00 }, /* Shift left rotating 50ms 50*/
  { 0x8C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00 }, /* Color clear */
  { 0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, /* Rec End. */
};
...
const uint8_t led_play_list3[][SERIALCOMMAND_FIXEDLEN] =
{
  { 0x94, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, /* Rec Start. */
  { 0x90, 0x01, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00 }, /* System */
  { 0x95, 0x36, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00 }, /* Rainbow */
  { 0x92, 0x00, 0x01, 0x00, 0x14, 0x00, 0xF4, 0x01 }, /* Shift right rotating 500ms 20*/
  { 0x8C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00 }, /* Color */
  { 0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, /* Rec End. */
};
...
const uint8_t led_play_list4[][SERIALCOMMAND_FIXEDLEN] =
{
  { 0x94, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, /* Rec Start. */
  { 0x90, 0x01, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00 }, /* System */
  { 0x8C, 0x23, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00 }, /* Color red 1*/
  { 0x92, 0x00, 0x01, 0x00, 0xC8, 0x00, 0x14, 0x00 }, /* Shift right rotating 20ms 200*/
  { 0x8C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00 }, /* Color */
  { 0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, /* Rec End. */
